    ...
    <View style={styles.container}>
      <View style={styles.cardPlaceholder}>
        <View style={styles.iconWrapper}>
          <PlusCircle size={32} color={COLORS.primary} strokeWidth={2} />
        </View>
        <Text style={styles.title}>Registrar Incidente</Text>
        <Text style={styles.subtitle}>
          Formulario en construcción para selección de calles de Cala Cala y
          categorías de problemas urbanos.
        </Text>
        <View style={styles.badgeHint}>
          <Sparkles size={14} color={COLORS.primary} />
          <Text style={styles.badgeHintText}>Módulo de creación activa</Text>
        </View>
      </View>
    </View>
  );
